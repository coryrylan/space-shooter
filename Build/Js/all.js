...
(function (e, undefined) {
    var t,
        ...
        K = { children: !0, contents: !0, next: !0, prev: !0 };x.fn.extend({ find: function (e) {
            var t,
                n = [],
                r = this,
        ...
        ut = /^true\/(.*)/,
        lt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
        ct = { option: [1, "<select multiple='multiple'>", "</select>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""] };ct.optgroup = ct.option, ct.tbody = ct.tfoot = ct.colgroup = ct.caption = ct.thead, ct.th = ct.td, x.fn.extend({ text: function (e) {
        ...
        zt = /^(?:input|select|textarea|keygen)/i;x.fn.extend({ serialize: function () {
        ...
        dn = /(=)\?(?=&|$)|\?\?/;x.ajaxSetup({ jsonp: "callback", jsonpCallback: function () {
        ...
        var t;return x.support.cors || gn && !e.crossDomain ? { send: function (n, r) {
                var i,
                    o,
